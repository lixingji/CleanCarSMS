...
shortYearCutoff:"+10",monthText:"月",dayText:"日",yearText:"年",hourText:"Hours",minuteText:"Minutes",secText:"Seconds",ampmText:"&nbsp;",nowText:"Now",showNow:!1,stepHour:1,stepMinute:1,stepSecond:1,separator:" "},A=function(d){function l(a,c,b){return void 0!==w[c]?+a[w[c]]:void 0!==b?b:ma[B[c]]?ma[B[c]]():B[c](ma)}function e(a,c,b,g){a.push({values:b,keys:c,label:g})}function j(a,c){return Math.floor(a/c)*c}function t(a){var c=l(a,"h",0);return new Date(l(a,"y"),l(a,"m"),l(a,"d",1),l(a,"a")?
